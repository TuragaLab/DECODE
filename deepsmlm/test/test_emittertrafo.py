...
def test_emitter_transformation():
    ...
    """Setup"""
    em = deepsmlm.RandomEmitterSet(200, extent=10000, xy_unit='nm')
    ...
    assert test_utils.tens_almeq(mod_em.xyz_nm, em.xyz_nm[:, [1, 0, 2]] * torch.tensor([1., 1., -1.]) + torch.tensor([-150., -50., 0.]))
