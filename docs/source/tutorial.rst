...
3. In SMAP, use the plugin *Analyze / calibrate3DSplinePSF* to generate the
   ...
   In the user guide (accessible from the SMAP help menu) in section 5.4, this is
   explained in detail. Further information about the calibration process can be
   found in `Li et al., Nature Methods (2018) <https://doi.org/10.1038/nmeth.4661>`__.
